...
//ProjectionFactor::ProjectionFactor(const Eigen::Vector3d &_pts_i, const Eigen::Vector3d &_pts_j, const Eigen::VectorXd &_pose_i) : pts_i(_pts_i), pts_j(_pts_j), pose_i(_pose_i)
...
//    Eigen::Quaterniond Qi(pose_i(6), pose_i(3), pose_i(4), pose_i(5));
...
//    double inv_dep_i = parameters[2][0];
    ...
    //std::cout << "POINT POSE i, j: " << Pi[0] << ", " << Pi[1] << ", " << Pi[2] << " | " << Pj[0] <<", "<< Pj[1] << ", "<< Pj[2]<< std::endl;
    ...
    //std::cout << "---IN POINT PROJ---" <<std::endl;
    ...
    //    std::cout << "point_residual" << std::endl;
...
//          std::cout <<"\nBEFORE POINT jacobians[2]" << std::endl;
//          std::cout <<"jacos size: " << malloc_usable_size(jacobians[2]) << std::endl;
//          for(int i=0; i<malloc_usable_size(jacobians[2])/sizeof(double); i++)
//          {
...
//            std::cout <<"\nMIDDLE POINT jacobians[2]" << std::endl;
//            std::cout <<"pose i size: " << sizeof(jacobian_ex_pose) <<std::endl;
//            std::cout << "jacobian_pose_i\n" << jacobian_ex_pose << std::endl;
//            for(int i=0; i<malloc_usable_size(jacobians[2])/sizeof(double); i++)
//            {
//              std::cout << jacobians[2][i] << ", " ;
//            }
...
//            std::cout <<"\nAFTER POINT jacobians[2]" << std::endl;
//            std::cout <<"pose i size: " << sizeof(jacobian_ex_pose) <<std::endl;
//            std::cout << "jacobian_pose_i\n" << jacobian_ex_pose << std::endl;
//            for(int i=0; i<malloc_usable_size(jacobians[2])/sizeof(double); i++)
//            {
